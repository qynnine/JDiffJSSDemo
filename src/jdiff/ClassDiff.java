...
class ClassDiff {
    ...
    //EBC added class doc for change
    ...
    /** Visibility of Class Modifier */
    public String modifiersVisibility_ = "";
    ...
    public void setModifiersVisibility_(String modifiersVisibility_) {
		this.modifiersVisibility_ = modifiersVisibility_;
	}

	public String getModifiersVisibility_() {
		return modifiersVisibility_;
	}
    ...
    //EBC we add the documentation of the new class to the change
    public void setNewDocumentation(String doc){
    	doc_=doc;
    }
}
