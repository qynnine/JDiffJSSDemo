...
//		SK - commented out because now method parameters are not considered
//        comp = getSignature().compareTo(oMethod.getSignature());
//        if (comp != 0)
//            return comp;
        
  //   Eya  Ben Charrada - commented out because we do not consider changes in methods documentation
